...
python3.9 main.py -d QM9 -m Delay-SP_RSUM_WEIGHT --rbar 5 --num_layers 10 --specific_task $SLURM_ARRAY_TASK_ID --mode gr --emb_dim 78 --batch_size 128 --epochs 300 --nb_reruns 2 --scatter mean --dropout 0.0 --layer_norm False --seed 1 --pool_gc True --run_id time_0116_1058